...
OUT = HERE.parents[2] / 'site/apps/010-veloce-bike-studio'


def build():
    npm = shutil.which('npm.cmd') or shutil.which('npm')
    if not npm:
        raise SystemExit('Building project 010 requires Node.js 22 and npm.')
    ...
    expected = (HERE.parents[2] / 'site/apps/010-veloce-bike-studio/assets').resolve()
    ...
    shutil.copytree(HERE / 'dist/client', OUT, dirs_exist_ok=True)
    ...
    print('Built 010: Veloce Bike Studio, static client and third-party licenses')
