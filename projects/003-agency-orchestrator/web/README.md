...
- 发布采用仓库现有 GitHub Pages 流程，已上线并验证：[在线网页](https://yydshly.github.io/0917_codex_project/apps/003-agency-orchestrator/)；正式地址已写入 `project.json.demo`。
...
2026-09-17 发布检查通过：从暂存文件独立构建并检查实际发布包；线上首页、子项目页、案例页、PNG / SVG / 文字版、案例记录、样式脚本及许可均返回正常，内容与构建产物一致。没有进行浏览器交互或视觉验收。
